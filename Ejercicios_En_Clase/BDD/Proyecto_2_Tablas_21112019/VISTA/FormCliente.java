...
public class FormCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipoDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DNI", "Documento Extranjero" }));
        ...
        jLabel10.setFont(new java.awt.Font("Constantia", 0, 36)); // NOI18N
        jLabel10.setText("Ingresar Datos");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        int seleccion = tipoDoc.getSelectedIndex();
        dts.setTipo_documento(tipoDoc.getItemAt(seleccion));
        ...
        if(accion.equals("guardar")){
            if(func.insertar(dts)){
                ...
                JOptionPane.showMessageDialog(rootPane, "Guardado con exito", "Mensaje", 1);
            }
        }
        limpiar();
