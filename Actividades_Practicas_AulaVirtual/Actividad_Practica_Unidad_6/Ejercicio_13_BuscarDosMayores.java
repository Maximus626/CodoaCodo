...
public class Ejercicio_13_BuscarDosMayores {
   ...
   public static void main(String[] args) {
    ...
    public static void buscarDosMayores(int[] vector){
        ...
        System.out.println("A continuación se buscarán los dos números mayores de este array");
        for (int i = 0; i < vector.length; i++) {
            if(vector[i]>mayor1&&vector[i]>mayor2){
                mayor1=vector[i];
                posicion1=(i+1);
            }if(vector[i]>mayor2&&vector[i]<mayor1){
                mayor2=vector[i];
                posicion2=(i+1);
            }
        }
        
        System.out.println("Los números encontrados como mayores fueron: ");
        System.out.println("El mayor de todos, el número "+mayor1+ " se encuentra en la posición n°"+posicion1);
        System.out.println("El segundo mayor, el número "+mayor2+ " se encuentra en la posición n°"+posicion2);
    }
}